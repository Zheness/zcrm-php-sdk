...
class ZCRMRecord
{
     ...
     * @param boolean $overWrite if the tags needs to overwrite or no
     * @throws ZCRMException if the record or module or tag doesn't exist
     * @return APIResponse APIResponse instance of the APIResponse class which holds the API response.
     */
    public function addTags($tagNames, $overWrite = false)
    {
        ...
        return TagAPIHandler::getInstance()->addTags($this, $tagNames, $overWrite);
    }
